...
public class Schedule {
    ...
    public Schedule(Collection<HourMinute> hourMinutes) {
        this(ZoneId.systemDefault(), hourMinutes);
    }


    public Schedule(ZoneId zoneId, Collection<HourMinute> hourMinutes) {
        this.zoneId = zoneId;
    ...
    public void findNext() {
        ...
        ZonedDateTime nextResetZDT = nextReset.toZonedDateTime(this.zoneId);
